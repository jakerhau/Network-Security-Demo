...
import { FaAngleLeft, FaLock, FaEnvelope, FaFaceSmile } from 'react-icons/fa6'
      ...
      return (
        <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 flex items-center justify-center px-4">
          <div className="max-w-md w-full bg-white rounded-2xl shadow-2xl p-8 text-center">
            ...
            <p className="text-gray-600 mb-6">Vui lòng sử dụng Safari trên iOS để đăng nhập bằng FaceID/TouchID.</p>
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 flex items-center justify-center px-4 py-12">
      <div className="max-w-md w-full">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-4xl font-bold text-gray-900 mb-2">Xin Chào</h1>
          <p className="text-gray-600">Đăng nhập với FaceID/TouchID để tiếp tục</p>
        </div>
